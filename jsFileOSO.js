...
ctx.fillText("Observe queues (in future)",20,300); 
...
ctx.fillText("Number of parts in queue",80,95);
ctx.fillText("Expected demand",80,110); 
ctx.fillText("Machine available",80,175); 
ctx.fillText("Machine / job selection",80,255);
